...
public class TimeTest1 {
    ...
    static Logger log = Logger.getLogger(TimeTest1.class);
    ...
    public void test() {
		// Test1 files
    	String T2FMapFileName = "src/test/resources/timetest1/Table2FieldMap.json";
		String F2DMapFileName = "src/test/resources/timetest1/Field2DimensionMap.json";

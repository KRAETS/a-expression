...
public class VirtualDimensions {
	private List<Dimension> virtualDimensions = null;
	...
	public VirtualDimensions(){
		this.virtualDimensions= new LinkedList<Dimension>();
	}
	public void addVirtualDimension(Dimension d){
		this.virtualDimensions.add(d);
	}
